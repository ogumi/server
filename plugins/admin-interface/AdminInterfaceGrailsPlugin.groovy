...
class AdminInterfaceGrailsPlugin {
		def version = "0.6.5-OGUMI-SNAPSHOT"
		...
		def title = "Grails Admin Interface - Patched"
		def author = "Naymspace"
		def authorEmail = "fs@naymspace.de"
		...
		def organization = [ name: "Naymspace", url: "http://naymspace.de" ]
